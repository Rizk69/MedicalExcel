...
class AppConstants {
  static const String appName = 'Medical Excel';
  static const String slogan = 'E-Commerce Marketplace';
  static const String appVersion = '14.1';
  static const String baseUrl = 'https://medicalexcel.org';//https://6valley.6amtech.com
  ...
  static const String latestProductUri = '/api/v1/products/latest';//api/v1/products/latest?guest_id=1&limit=10&&offset=
  ...
  static const String productDetailsUri = '/api/v1/products/details/';//api/v1/products/details/
