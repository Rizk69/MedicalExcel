  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        //             .socialLogin![2]
        //             .status!)
            (Provider.of<SplashProvider>(context, listen: false).configModel != null &&
               Provider.of<SplashProvider>(context, listen: false).configModel!.socialLogin != null &&
               Provider.of<SplashProvider>(context, listen: false).configModel!.socialLogin!.isNotEmpty)
