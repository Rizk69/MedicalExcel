                ...
                child: Column(crossAxisAlignment:CrossAxisAlignment.start,
                  children: [
                    ...
                    Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Row(
                        children: orderProvider.paymentMethodIndex != -1
                            ? [
                          SizedBox(
                            width: 40,
                            child: CustomImage(
                              image: orderProvider.paymentMethodIndex != -1 &&
                            configProvider.configModel?.paymentMethods != null &&
                            orderProvider.paymentMethodIndex < configProvider.configModel!.paymentMethods!.length
                            ? '${configProvider.configModel!.paymentMethodImagePath}/${configProvider.configModel!.paymentMethods![orderProvider.paymentMethodIndex].additionalDatas?.gatewayImage ?? ''}'
                              : 'fallback_image_path', // Provide a fallback image path or handle it accordingly
                            ),
                          ),
                          Padding(
                            ...
                            child: Text(
                              // configProvider.configModel!.paymentMethods![orderProvider.paymentMethodIndex].additionalDatas!.gatewayTitle??'',
                                orderProvider.paymentMethodIndex != -1 &&
                                    configProvider.configModel?.paymentMethods != null &&
                                    orderProvider.paymentMethodIndex < configProvider.configModel!.paymentMethods!.length &&
                                    configProvider.configModel!.paymentMethods![orderProvider.paymentMethodIndex].additionalDatas != null
                                    ? configProvider.configModel!.paymentMethods![orderProvider.paymentMethodIndex].additionalDatas!.gatewayTitle ?? ''
                                    : 'Empty'
                            ),
                          ),
                        ]
                            : [/* Your default or empty widget here */],
                      ):
