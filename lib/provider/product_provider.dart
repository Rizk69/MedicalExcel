...
int selectedProductTypeIndex = 0;
 void changeTypeOfProduct(ProductType type, String? title, {int index = 0}){
  ...
  Future<void> getRecommendedProduct() async {
    ApiResponse apiResponse = await productRepo!.getRecommendedProduct();
    if (apiResponse.response != null && apiResponse.response!.statusCode == 200) {
      List<dynamic> products = apiResponse.response!.data;
      ...
      _recommendedProduct = productList ;
    }
    notifyListeners();
  }
  ...
  //       // Assuming you want to take the first product in the list
  //       _recommendedProduct = Product.fromJson(responseData.first);
  //     }
  //   }
  //
  //   notifyListeners();
