    ...
    if (apiResponse.response != null && apiResponse.response!.statusCode == 200) {
      ...
      if (offset == 0) {
       ...
       searchedProduct = ProductModel.fromJson(apiResponse.response!.data);
        if (searchedProduct?.products != null) {
          log('message1>>>${apiResponse.response?.data}');
          searchedProduct = ProductModel.fromJson(apiResponse.response!.data);
          log('message2>>>${searchedProduct!.products}');
          print("search yes");
          log('message>>>${jsonEncode(searchedProduct?.products)}');
        }
      }
      else {
        ...
        //     print("search yes");
        //     searchedProduct = ProductModel.fromJson(apiResponse.response!.data);
        //     log('message>>>'+jsonEncode(searchedProduct).toString());
        //   }
        // }else{
        print("search no");
        log('message>>>'+'yess');
